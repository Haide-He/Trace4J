...
class _BaseTraceGenerator:
    def __init__(self, filename : str):
        ...
        self.list_max_size = 64  # modified
    ...
    def _track_open(self, uuid, ts, annotation, kwargs, flow, categories, caller = None):
        pkt = self.trace.packet.add()

        pkt.timestamp = int(ts)
        ...
        pkt.track_event.track_uuid = uuid
        pkt.track_event.categories.append(categories)
