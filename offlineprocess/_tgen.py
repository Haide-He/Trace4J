...
class NormalTrack:
    def __init__(self, name, parent, uuid):
        ...
        self._uuid = uuid
        self._name = name
    def open(self, ts, annotation, kwargs = None, flow = [], categories = ""):
        """ Open a track. """
        self._parent._track_open(self._uuid, ts, annotation, kwargs, flow, categories)
        return self
...
class Group:
    ...
    def open(self, ts : int, annotation : str, kwargs : dict = None, flow : list = [], categories : str = ""):
        """ Open track. """
        self._parent._track_open(self._uuid, ts, annotation, kwargs, flow, categories)
