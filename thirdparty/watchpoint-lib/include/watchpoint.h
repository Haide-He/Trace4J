...
typedef enum WP_TriggerAction_t {WP_DISABLE, WP_ALREADY_DISABLED, WP_DISABLE_ALL, WP_RETAIN, WP_TRIGGERED} WP_TriggerAction_t;
...
extern void linux_perf_events_reset();
